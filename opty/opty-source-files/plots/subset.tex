...
\begin{document}
	...
	\addplot[mark=*, mark size=1pt, black, error bars/.cd,     error bar style={line width=0.75pt} ,  y explicit,y dir=both] table [x index=0, y index=1, y error expr=\thisrowno{2} * 1 , col sep=comma]{../subset_backup/clean};	
	\addlegendentry{10 Clients, 10 Entries, 1 Read, 1 Write, 4sec};

	\addplot[mark=*, mark size=1pt, red, error bars/.cd,     error bar style={line width=0.75pt} ,  y explicit,y dir=both] table [x index=0, y index=1, y error expr=\thisrowno{2} * 1 , col sep=comma]{../subset/clean};	
	\addlegendentry{20 Clients, 10 Entries, 1 Read, 1 Write, 4sec};
