...
\begin{document}
	...
	\foreach \k in {1, ..., \kMAX} 
	{
	    ...
	    \addplot+[mark=*, mark size=1pt, error bars/.cd,  y explicit,y dir=both] table [x index=0, y index=1, y error expr=\thisrowno{2} * 1 , col sep=comma]{../numclients3/clean_\k};	
	    \expandafter\addlegendentry\expandafter{\k \ Entries};
	    \addplot+[smooth,mark=square, black, nodes near coords, nodes near coords align=horizontal, nodes near coords style={font=\tiny}, forget plot] coordinates {(1024, 50/\k)};
