...
Both algorithms have the same behaviour. The lower are the entries accessed, the higher are the success rate. Less entries accessed per client implies having less probability of clashes between transactions. This impact is lowen in \textit{timey}, in which we obtaining smoother curves.
