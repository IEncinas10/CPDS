...
In my opinion this practice have been interesting. I learned a bit more of Erlang and taking some challenges that before practice didn't have. We have understand the opty algorithm and also timey to compare them. Also the main challenge (from my point of view) of modify the code of opty without a "guide" code to implement forward validation, facing with real Erlang language.
