...
\bottomrule
\end{tabular}
\caption{Time to compute an image size 256x256}
\end{table}
...
\bottomrule
\end{tabular}
\caption{Time to compute an image size 512x512}
\end{table}
...
\bottomrule
\end{tabular}
\caption{Time to compute an image size 1024x1024}
\end{table}

\clearpage
\subsection{MPI}

MPI implementations of Jacobi and Gauss-Seidel has been tested in Boada, using 1, 2, 4 and 8 nodes for images of size 256, 512, 1024 respectively.
...
2     & 180,705 & 181      \\
4     & 365,47  & 370      \\
  8     & Time Out\footnote{The Job submitted to Boada get killed because it lasted too much} & Time Out  \\
\bottomrule
\end{tabular}
\caption{Time to compute an image size 1024x1024}
\end{table}
