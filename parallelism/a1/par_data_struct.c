...
char **argv;
{
    ...
    /* S1, S2: Obtain MPI Context: process 'ID' and number of processes */
    ...
    /* S3: Specify the MPI Communicator */
    ...
    /* S4: Specify nº of elements to send, datatype and Communicator */
    ...
    /* S5: Specify nº of elements to send, datatype and Communicator */
    ...
    /*
     * S6: Specify nº of elements to receive per process, datatype, operation to perform, rank of root process, and
     * communicator. MPI_SUM tells MPI to SUM these partials error, so we obtain the total amount of errors
     */
