...
\begin{document}
	...
	\addlegendentry{2 Clients, 3 Read, 3 Write, 4sec};

	\addplot[mark=*, mark size=1pt, red, error bars/.cd,  y explicit,y dir=both] table [x index=0, y index=1, y error expr=\thisrowno{2} * 1 , col sep=comma]{../numentries3/clean};	
	\addlegendentry{2 Clients, 10 Read, 10 Write, 4sec};
