...
\begin{document}
	...
	\addplot[mark=pentagon, mark size=1pt, black] table [col sep=comma]{../dropvote/clean};	
	\addlegendentry{Agreement time};
	
        %\addplot[black, thick, samples=50, domain=0:5000] {35000};
        %\addlegendentry{Did not finish}

	\addplot[thick, samples=50, smooth,domain=0:6,red, forget plot] coordinates {(90,0)(90,35000)};

	\path[name path=A] (axis cs:90,0) -- (axis cs:90,35000);
