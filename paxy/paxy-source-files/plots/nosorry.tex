...
\begin{document}
	...
	\addplot[mark=triangle, mark size=1pt, black] table [col sep=comma]{../exp1/clean};	
        ...
        %\addplot[black, thick, samples=50, domain=0:6000] {20000};
	...
	%\draw[dashed] (axis cs:0,200) -- (axis cs:6000, 200);
	%\addlegendentry{Proposer starting delay}

	\addplot [dashed, samples=200,domain=0:5000] coordinates {(0, 200)(5000,200)};
	\addlegendentry{Proposer starting delay};

	\addplot[mark=pentagon, mark size=1pt, orange] table [col sep=comma]{../nosorry/clean};	
